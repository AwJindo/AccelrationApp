...
public class DeviceControlActivity extends AppCompatActivity {
    ...
    public static ArrayList<Integer> ArrData = new ArrayList<>();
    ...
    private final BluetoothGattCallback btleGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, final BluetoothGattCharacteristic characteristic) {
            ...
            mDataField.setText(String.valueOf(data));
        ...
        public void onServicesDiscovered(final BluetoothGatt gatt, final int status) {
            ...
            for (BluetoothGattService gattService : bluetoothGatt.getServices()) {
                ...
                if (uuids[0].contains("1111")) { // make your changes here to adjust with your device's UUID
                    ...
                    for (BluetoothGattCharacteristic gattCharacteristic :
                        ...
                        if (charUuids[0].contains("2100")) { // make your changes here to adjust with your device's UUID
